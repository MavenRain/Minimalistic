...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="VSOAccessTokenWorkerRole" generation="1" functional="0" release="0" Id="8d594d54-20af-419e-ba81-0b4d2cffa57c" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="VSOAccessTokenWorkerRoleGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="AccessTokenWorkerRole" generation="1" functional="0" release="0" software="D:\Users\v-oniobi\Documents\Minimalistic\VSOAccessTokenWorkerRole\csx\Release\roles\AccessTokenWorkerRole" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="-1" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <componentports>
              <inPort name="Default" protocol="http" portRanges="80" />
            </componentports>
            <settings>
  ...
  <implements>
    <implementation Id="67f19aaf-d8e6-4179-a305-eb701076142f" ref="Microsoft.RedDog.Contract\ServiceContract\VSOAccessTokenWorkerRoleContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="9b18655c-4b3f-4adc-a6e8-36beb64493f4" ref="Microsoft.RedDog.Contract\Interface\AccessTokenWorkerRole:Default@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/VSOAccessTokenWorkerRole/VSOAccessTokenWorkerRoleGroup/AccessTokenWorkerRole:Default" />
          </inPort>
        </interfaceReference>
